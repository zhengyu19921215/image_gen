...
def gen_letter_integer(num_len,characters,save_path,file_txt,fonts_size,size,fonts_path):
    #########################生成小数
    ...
    f.close()
def gen_letter(num_len,characters,save_path,file_txt,fonts_size,len_number,size,fonts_path):
    #########################生成整数
    for i in range(num_len):
        font_size = random.choice(fonts_size)
        font_path = 'Fonts/' + random.choice(fonts_path)
